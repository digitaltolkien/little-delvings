...
plt.title("Distribution of Words per Paragraph in Lord of the Rings", weight="semibold")

plt.text(-110, -220, "Digital Tolkien Project • digitaltolkien.com", size="medium", color="black", weight="medium")
plt.text(590, -220, "Little Delving #006", horizontalalignment="right", size="medium", color="black", weight="medium")
