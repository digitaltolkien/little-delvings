...
plt.title("Distribution of Words per Paragraph in the Silmarillion", weight="semibold")

plt.text(-110, -20, "Digital Tolkien Project • digitaltolkien.com", size="medium", color="black", weight="medium")
plt.text(590, -20, "Little Delving #011", horizontalalignment="right", size="medium", color="black", weight="medium")
